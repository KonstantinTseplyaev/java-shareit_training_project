...
public class BookingServiceIntegrationTest {
    ...
    void setUp() {
        ...
        booking1 = Booking.builder()
                .item(item1)
                .user(user)
                .start(LocalDateTime.of(2023, 10, 25, 13, 0))
                .end(LocalDateTime.of(2023, 10, 26, 13, 0))
                .state(State.WAITING)
        ...
        booking3 = Booking.builder()
                .item(item2)
                .user(user)
                .start(LocalDateTime.of(2022, 7, 16, 13, 0))
                .end(LocalDateTime.of(2022, 7, 17, 13, 0))
                .state(State.WAITING)
                .itemOwnerId(owner.getId())
                .build();
        ...
        booking4 = Booking.builder()
                .item(item2)
                .user(user)
                .start(LocalDateTime.of(2023, 10, 27, 13, 0))
                .end(LocalDateTime.of(2023, 10, 28, 13, 0))
                .state(State.WAITING)
                .itemOwnerId(owner.getId())
                .build();
    }
